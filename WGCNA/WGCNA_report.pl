...
<html>
	...
	<body>
		...
		<nav id="cd-vertical-nav">
			<ul>
				<li>
					<a href="#wgcna_info" data-number="1">
						<span class="cd-dot"></span>
						<span class="cd-label">WGCNA介绍</span>
					</a>
				</li>
				<li>
					<a href="#filter" data-number="2">
						<span class="cd-dot"></span>
						<span class="cd-label">数据过滤</span>
					</a>
				</li>
				<li>
					<a href="#feature_evaluation" data-number="3">
						<span class="cd-dot"></span>
						<span class="cd-label">特征评估</span>
					</a>
				</li>
				<li>
					<a href="#basic_info" data-number="4">
						<span class="cd-dot"></span>
						<span class="cd-label">模块概况</span>
					</a>
				</li>
				<li>
					<a href="#modules" data-number="5">
						<span class="cd-dot"></span>
						<span class="cd-label">表达模式</span>
					</a>
				</li>
				<li>
					<a href="#enrichment" data-number="6">
						<span class="cd-dot"></span>
						<span class="cd-label">富集分析</span>
					</a>
				</li>
				<li>
					<a href="#catalog" data-number="7">
						<span class="cd-dot"></span>
						<span class="cd-label">目录结构</span>
					</a>
				</li>
			</ul>
		</nav>
		...
		<div id="report_body">
			...
			<!-- WGCNA特征评估 -->
			<section id="feature_evaluation" class="normal_cont">
				<h3>特征评估<a href="doc/wgcna_assess.html" target="help_page" onclick="show_help();"><img src="image/help.png" class="help_logo"></a></h3>
				<p>在进行WGCNA网络构建的第一大步骤就是根据基因集中基因的表达量进行特征聚类同时构建无尺度网络寻找使网络拓扑结构趋于稳定的Power值，我们就可以根据这些特征值进行模块的划分。本次分析选用的特征参数如下：</p>
				<p>Power值： $wgcna{softPower}</p>
				<p>相似度： $wgcna{disSimilarity}</p>
				<p>基因-模块对应关系列表： <a href="../2.feature_evaluation/4.netcolor2gene.xls"> 4.netcolor2gene.xls </a></p>
				<div id="parentVerticalTab1" class="VerticalTab">
					...
					<div class="resp-tabs-container hor_1">
						<div>
							<a href="../2.feature_evaluation/1.sampleClustering.png" target="_blank">
								<img src="../2.feature_evaluation/1.sampleClustering.png" />
							</a>
						</div>
						<div>
							<a href="../2.feature_evaluation/2.softPower.png" target="_blank">
								<img src="../2.feature_evaluation/2.softPower.png" />
							</a>
						</div>
						<div>
							<a href="../2.feature_evaluation/3.eigengeneClustering.png" target="_blank">
								<img src="../2.feature_evaluation/3.eigengeneClustering.png" />
							</a>
						</div>
						<div>
							<a href="../2.feature_evaluation/4.ModuleTree.png" target="_blank">
								<img src="../2.feature_evaluation/4.ModuleTree.png" />
							</a>
						</div>
					</div>
				</div>
		...
		if( -s "$out/5.enrichment/KO/pv.kegg.png" && -s "$out/5.enrichment/KO/qv.kegg.png" && -s "$out/5.enrichment/KO/rf.kegg.png"){
			print HTML <<HTML_cont;
				...
				<div id="parentVerticalTab7" class="VerticalTab">
					<ul class="resp-tabs-list hor_7">
						<li>P值热图</li>
						<li>Q值热图</li>
						<li>富集因子热图</li>
					</ul>
					<div class="resp-tabs-container hor_7">
						<div>
...
│   ├── 3.eigengeneClustering.pdf        特征基因聚类树-矢量图
│   ├── 3.eigengeneClustering.png        特征基因聚类树-位图
